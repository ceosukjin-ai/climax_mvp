...
_COEF = [-0.21723572447097203, 0.5897385435090781, 0.2753516139244001, 1.1580042243863278, -0.2179636564753836, 1.9445166196716002, 0.12376803555283157, -0.09748237010933379, -1.8705800166806732, -0.43811985769891065]
_INTERCEPT = 2.883749999999988
_MEAN = [0.7375, 0.7217137499999997, 0.03488375, 35.23249999999999, 49.015, 0.5562499999999999, 62.230000000000004, 51.412125000000024, 43.214625, 0.14764253344763992]
_STD = [0.43999289866995084, 0.14577655153518554, 0.04986187381819145, 1.4922110283014343, 5.152186430080376, 0.4421096452060499, 5.669929453823907, 6.689635584077377, 4.639683972929015, 0.12361080517765517]
# 학습 분포 경계(min/max ±10%) — 밖이면 폴백
_BOUNDS = {"볕": [-0.1, 1.1], "tier3_svf": [0.22188999999999998, 1.03681], "tier3_gvi": [-0.030109999999999998, 0.33121], "Ta": [31.33, 39.370000000000005], "RH": [38.46, 64.14], "v": [-0.22000000000000003, 2.4200000000000004], "태양고도": [43.89, 69.21], "run_C_Tmrt": [35.823, 59.667], "run_C_PET": [31.874000000000002, 52.946], "ndvi30": [-0.05181709475443823, 0.7594938183947761]}
TRAINED_ON = "80 field points Busan 2026-08 (LOSO MAE 2.66)"
