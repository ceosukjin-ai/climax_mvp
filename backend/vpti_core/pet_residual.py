...
_COEF = [-0.4195062799488868, 0.48801303026543175, 0.28086352922429103, 1.0678503518238762, -0.25532697859099357, 1.9612903817447178, 0.0955804818463681, -0.21797352103547674, -1.4927508514597556, -0.41159247269244853]
_INTERCEPT = 2.3318749999999904
_MEAN = [0.7375, 0.7217137499999997, 0.03488375, 35.23249999999999, 49.015, 0.5562499999999999, 62.230000000000004, 51.56150000000001, 43.76649999999999, 0.14764253344763992]
_STD = [0.43999289866995084, 0.14577655153518554, 0.04986187381819145, 1.4922110283014343, 5.152186430080376, 0.4421096452060499, 5.669929453823907, 6.7574294493923395, 4.619025628770428, 0.12361080517765517]
# 학습 분포 경계(min/max ±10%) — 밖이면 폴백
_BOUNDS = {"볕": [-0.1, 1.1], "tier3_svf": [0.22188999999999998, 1.03681], "tier3_gvi": [-0.030109999999999998, 0.33121], "Ta": [31.33, 39.370000000000005], "RH": [38.46, 64.14], "v": [-0.22000000000000003, 2.4200000000000004], "태양고도": [43.89, 69.21], "run_C_Tmrt": [35.806999999999995, 59.723], "run_C_PET": [32.116, 52.924], "ndvi30": [-0.05181709475443823, 0.7594938183947761]}
TRAINED_ON = "80 field points Busan 2026-08, engine v2 wind_is_pedestrian (LOSO MAE 2.64)"
