...
#
# 2026-08-26 전국 확장. 그 전까지 부산 한 곳뿐이라 서울·대구 사용자는 실측 운량을
# 한 번도 못 받고 항상 SKY 예보로 폴백하고 있었다. 앱은 전국 개방인데 실측 축은
# 부산에만 있었던 셈이다.
#
# ⚠️ 아래 좌표는 **검증 대상**이다. 배포 전에 반드시 한 번 돌릴 것:
#       python3 scripts/verify_asos_stations.py
#    기상청 API허브의 지점정보(stn_inf)를 받아 이 표와 대조한다.
#    지점번호가 틀리면 **다른 도시의 관측값을 그 도시 것이라고 내보내게 된다** —
#    좌표가 몇백 m 어긋나는 건 50km 반경에서 무해하지만, 번호가 틀리면 치명적이다.
#
...
ASOS_STATIONS: dict[int, tuple[float, float]] = {
    ...
    112: (37.47763, 126.62473),   # 인천
    119: (37.25746, 126.98297),   # 수원
    201: (37.70739, 126.44634),   # 강화
    114: (37.33756, 127.94662),   # 원주
    105: (37.75147, 128.89099),   # 강릉
    90:  (38.25085, 128.56463),   # 속초
    100: (37.67713, 128.71834),   # 대관령
    # 충청
    133: (36.37198, 127.37209),   # 대전
    131: (36.63917, 127.44064),   # 청주
    129: (36.77656, 126.49392),   # 서산
    127: (36.97051, 127.95274),   # 충주
    232: (36.77659, 127.12127),   # 천안
    # 전라
    156: (35.17294, 126.89156),   # 광주
    146: (35.84092, 127.11720),   # 전주
    140: (36.00538, 126.76158),   # 군산
    165: (34.81732, 126.38151),   # 목포
    168: (34.73929, 127.74063),   # 여수
    # 경상
    143: (35.87797, 128.65296),   # 대구
    159: (35.10468, 129.03203),   # 부산
    152: (35.58221, 129.33887),   # 울산
    155: (35.17017, 128.57262),   # 창원
    138: (36.03287, 129.38000),   # 포항
    136: (36.57287, 128.70733),   # 안동
    192: (35.16378, 128.04004),   # 진주
    162: (34.84537, 128.43559),   # 통영
    279: (36.13112, 128.32060),   # 구미
    # 제주
