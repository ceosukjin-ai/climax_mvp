...
LCZ = [("LCZ 1", "부암제1동", "Buam 1",     "o", 11.0, "#1F6FB2"),
       ("LCZ 2", "보수동",   "Bosu",       "s",  9.0, "#0B9A9C"),
       ("LCZ 3", "서제2동",  "Seo 2",      "^", 12.0, "#6E9A3A"),
       ("LCZ 4", "용호제1동", "Yongho 1",   "D",  7.5, "#D94801"),
       ("LCZ 5", "명장동",   "Myeongjang", "v", 12.0, "#7A5AA8")]
