...
SV, NOSV, RED, PINK = "#2E75B6", "#E8A33D", "#C0392B", "#EDEDEB"        # street view of its own: black; none (alley / block interior): red
MM = 1 / 25.4; THR = 41.0
...
fig.text(0.5, 0.005, "grey quadrant: measured ≥ 41 °C but estimated below — extreme heat missed", ha="center", va="bottom", fontsize=6.6, color=MUTED)
